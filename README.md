# Portafolio Digital | Jhoanna Arevalo Padilla

Hola, soy **Jhoanna Arevalo Padilla**, egresada de **Desarrollo de Sistemas de Información** por IDAT, con experiencia en desarrollo backend, bases de datos, desarrollo web, soporte técnico TI, hosting y documentación funcional de proyectos.

Este repositorio reúne una selección de mis principales proyectos desarrollados en entornos académicos, independientes, freelance y profesionales, mostrando mi participación técnica, tecnologías utilizadas, funcionalidades implementadas y valor aportado.

---

## Perfil profesional

Desarrolladora .NET/C# Jr., Analista de Sistemas y Soporte Técnico TI Nivel 2.  
Cuento con experiencia en proyectos con **C#, .NET, Java, Spring Boot, SQL Server, MySQL, Dapper, procedimientos almacenados, arquitectura por capas, microservicios, Git, GitHub, GitLab, HTML, CSS, JavaScript, WordPress, hosting y soporte TI**.

Me enfoco en construir soluciones tecnológicas funcionales, documentadas y orientadas a la mejora de procesos.
...
**Ubicación:** Lima, Perú  
**Correo:** wippi1511@gmail.com  
**LinkedIn:** linkedin.com/in/jhoanna-arevalo-padilla-aba203256/
